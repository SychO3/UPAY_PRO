<?php
namespace gateways\upay_usdc_bsc;

class UpayUsdcBscPlugin extends \app\admin\lib\Plugin
{
    public $info = [
        "name" => "UpayUsdcBsc", 
        "title" => "USDC-BSC", 
        "description" => "USDC-BSC", 
        "status" => 1, 
        "author" => "UPAY", 
        "version" => "1.0.0", 
        "module" => "gateways"
    ...
    public function UpayUsdcBscHandle($param)
    {
        $Con = new \gateways\upay_usdc_bsc\controller\ConfigController();
    ...
    private function filterPay($order_no, $amount)
    {
        ...
        $param = [
            ...
            "notify_url" => $domain . "/gateway/upay_usdc_bsc/index/notify_handle",
            "redirect_url" => $domain . "/viewbilling?id=" . $order_no,
            "type" => "USDC-BSC"  // 固定为USDC-BSC
        ];
