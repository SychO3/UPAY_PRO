<?php
namespace gateways\upay_usdt_trc20;

class UpayUsdtTrc20Plugin extends \app\admin\lib\Plugin
{
    public $info = [
        "name" => "UpayUsdtTrc20", 
        "title" => "USDT-TRC20", 
    ...
    public function UpayUsdtTrc20Handle($param)
    {
        $Con = new \gateways\upay_usdt_trc20\controller\ConfigController();
    ...
    private function filterPay($order_no, $amount)
    {
        ...
        $param = [
            ...
            "notify_url" => $domain . "/gateway/upay_usdt_trc20/index/notify_handle",
            "redirect_url" => $domain . "/viewbilling?id=" . $order_no,
            "type" => "USDT-TRC20"  // 固定为USDT-TRC20
        ];
