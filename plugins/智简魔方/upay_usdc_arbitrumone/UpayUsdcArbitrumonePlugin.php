<?php
namespace gateways\upay_usdc_arbitrumone;

class UpayUsdcArbitrumonePlugin extends \app\admin\lib\Plugin
{
    public $info = [
        "name" => "UpayUsdcArbitrumone", 
        "title" => "USDC-ArbitrumOne", 
        "description" => "USDC-ArbitrumOne", 
        "status" => 1, 
        "author" => "UPAY", 
        "version" => "1.0.0", 
        "module" => "gateways"
    ...
    public function UpayUsdcArbitrumoneHandle($param)
    {
        $Con = new \gateways\upay_usdc_arbitrumone\controller\ConfigController();
    ...
    private function filterPay($order_no, $amount)
    {
        ...
        $param = [
            ...
            "notify_url" => $domain . "/gateway/upay_usdc_arbitrumone/index/notify_handle",
            "redirect_url" => $domain . "/viewbilling?id=" . $order_no,
            "type" => "USDC-ArbitrumOne"  // 固定为USDC-ArbitrumOne
        ];
