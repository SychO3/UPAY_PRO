<?php
namespace gateways\upay_usdc_arbitrumone\controller;
...
class IndexController extends \think\Controller
{
    public function notify_handle()
    {
        ...
        $up_data["payment"] = "USDC-ArbitrumOne";
    ...
    {
        echo "<script>console.log('upay_usdc_arbitrumone redirect');this.window.opener = null;window.open('about:blank','_self');window.close();</script>";
    }
}
