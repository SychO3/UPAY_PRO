<?php
namespace gateways\upay_usdc_erc20\controller;
...
class IndexController extends \think\Controller
{
    ...
    {
        echo "<script>console.log('upay_usdc_erc20 redirect');this.window.opener = null;window.open('about:blank','_self');window.close();</script>";
    }
}
