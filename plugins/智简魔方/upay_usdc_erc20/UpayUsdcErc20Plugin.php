<?php
namespace gateways\upay_usdc_erc20;

class UpayUsdcErc20Plugin extends \app\admin\lib\Plugin
{
    public $info = [
        "name" => "UpayUsdcErc20", 
        "title" => "USDC-ERC20", 
    ...
    public function UpayUsdcErc20Handle($param)
    {
        $Con = new \gateways\upay_usdc_erc20\controller\ConfigController();
    ...
    private function filterPay($order_no, $amount)
    {
        ...
        $param = [
            ...
            "notify_url" => $domain . "/gateway/upay_usdc_erc20/index/notify_handle",
            "redirect_url" => $domain . "/viewbilling?id=" . $order_no,
            "type" => "USDC-ERC20"  // 固定为USDC-ERC20
        ];
