<?php
namespace gateways\upay_usdt_erc20;

class UpayUsdtErc20Plugin extends \app\admin\lib\Plugin
{
    public $info = [
        "name" => "UpayUsdtErc20", 
        "title" => "USDT-ERC20", 
    ...
    public function UpayUsdtErc20Handle($param)
    {
        $Con = new \gateways\upay_usdt_erc20\controller\ConfigController();
    ...
    private function filterPay($order_no, $amount)
    {
        ...
        $param = [
            ...
            "notify_url" => $domain . "/gateway/upay_usdt_erc20/index/notify_handle",
            "redirect_url" => $domain . "/viewbilling?id=" . $order_no,
            "type" => "USDT-ERC20"  // 固定为USDT-ERC20
        ];
