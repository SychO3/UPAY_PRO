<?php
namespace gateways\upay_usdt_bsc;

class UpayUsdtBscPlugin extends \app\admin\lib\Plugin
{
    public $info = [
        "name" => "UpayUsdtBsc", 
        "title" => "USDT-BSC", 
    ...
    public function UpayUsdtBscHandle($param)
    {
        $Con = new \gateways\upay_usdt_bsc\controller\ConfigController();
    ...
    private function filterPay($order_no, $amount)
    {
        ...
        $param = [
            ...
            "notify_url" => $domain . "/gateway/upay_usdt_bsc/index/notify_handle",
            "redirect_url" => $domain . "/viewbilling?id=" . $order_no,
            "type" => "USDT-BSC"  // 固定为USDT-BSC
        ];
