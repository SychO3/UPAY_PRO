<?php
namespace gateways\upay_usdt_bsc\controller;
...
class IndexController extends \think\Controller
{
    ...
    {
        echo "<script>console.log('upay_usdt_bsc redirect');this.window.opener = null;window.open('about:blank','_self');window.close();</script>";
    }
}
