<?php
namespace gateways\upay_usdt_arbitrumone;

class UpayUsdtArbitrumonePlugin extends \app\admin\lib\Plugin
{
    public $info = [
        "name" => "UpayUsdtArbitrumone", 
        "title" => "USDT-ArbitrumOne", 
        "description" => "USDT-ArbitrumOne", 
        "status" => 1, 
        "author" => "UPAY", 
        "version" => "1.0.0", 
        "module" => "gateways"
    ...
    public function UpayUsdtArbitrumoneHandle($param)
    {
        $Con = new \gateways\upay_usdt_arbitrumone\controller\ConfigController();
    ...
    private function filterPay($order_no, $amount)
    {
        ...
        $param = [
            ...
            "notify_url" => $domain . "/gateway/upay_usdt_arbitrumone/index/notify_handle",
            "redirect_url" => $domain . "/viewbilling?id=" . $order_no,
            "type" => "USDT-ArbitrumOne"  // 固定为USDT-ArbitrumOne
        ];
