...
class IndexController extends \think\Controller
{
    public function notify_handle()
    {
        ...
        $up_data["payment"] = "USDT-ArbitrumOne";
    ...
    {
        echo "<script>console.log('upay_usdt_arbitrumone redirect');this.window.opener = null;window.open('about:blank','_self');window.close();</script>";
    }
}
