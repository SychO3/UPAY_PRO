<?php
namespace gateways\upay_trx;

class UpayTrxPlugin extends \app\admin\lib\Plugin
{
    public $info = [
        "name" => "UpayTrx", 
        "title" => "TRX", 
    ...
    public function UpayTrxHandle($param)
    {
        $Con = new \gateways\upay_trx\controller\ConfigController();
    ...
    private function filterPay($order_no, $amount)
    {
        ...
        $param = [
            ...
            "notify_url" => $domain . "/gateway/upay_trx/index/notify_handle",
