<?php
namespace gateways\upay_trx\controller;
...
class IndexController extends \think\Controller
{
    ...
    {
        echo "<script>console.log('upay_trx redirect');this.window.opener = null;window.open('about:blank','_self');window.close();</script>";
    }
}
