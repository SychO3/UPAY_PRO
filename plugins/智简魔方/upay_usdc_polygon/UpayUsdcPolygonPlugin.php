<?php
namespace gateways\upay_usdc_polygon;

class UpayUsdcPolygonPlugin extends \app\admin\lib\Plugin
{
    public $info = [
        "name" => "UpayUsdcPolygon", 
        "title" => "USDC-Polygon", 
        "description" => "USDC-Polygon", 
        "status" => 1, 
        "author" => "UPAY", 
        "version" => "1.0.0", 
        "module" => "gateways"
    ...
    public function UpayUsdcPolygonHandle($param)
    {
        $Con = new \gateways\upay_usdc_polygon\controller\ConfigController();
    ...
    private function filterPay($order_no, $amount)
    {
        ...
        $param = [
            ...
            "notify_url" => $domain . "/gateway/upay_usdc_polygon/index/notify_handle",
            "redirect_url" => $domain . "/viewbilling?id=" . $order_no,
            "type" => "USDC-Polygon"  // 固定为USDC-Polygon
        ];
